            ...
            <div className="flex-grow mb-6">
              ...
              <div className="bg-white/5 rounded-lg p-3 mb-4">
                <p className="text-purple-200 text-xs leading-relaxed">
                  <strong className="text-white">Это не гадание.</strong> Квадрат Пифагора — это аналитический инструмент, известный более 2500 лет. 
                  Он не предсказывает будущее, но показывает, с чем вы пришли в эту жизнь и на что можно опереться.
                </p>
              </div>
              ...
              <p className="text-purple-200 text-xs leading-relaxed">
                Потому что это:<br/>
                • не калькулятор из интернета (там нет расшифровок)<br/>
                • не общая статья (всё под вашу дату)<br/>
                • не консультация с ожиданием (вы получаете PDF сразу)<br/><br/>
