    ...
    return (
      <article className="prose prose-purple max-w-none">
        ...
        <section className="mb-8">
          ...
          <div className="ml-6 mb-4">
            <p className="text-gray-700 mb-2 leading-relaxed"><strong>3.1.1.0.</strong> Тариф &laquo;Матрица Судьбы&raquo; (включает в себя предоставление доступа к одной полной расшифровке &laquo;Матрицы Судьбы&raquo;. При этом доступ будет открыт сразу после оплаты).</p>
            <p className="text-gray-700 mb-2 leading-relaxed"><strong>3.1.1.1.</strong> Тариф &laquo;Прогноз на 10 лет&raquo; (включает в себя предоставление доступа к расшифровке по одному прогнозу на 10 ближайших лет. При этом доступ будет открыт сразу после оплаты).</p>
            <p className="text-gray-700 mb-2 leading-relaxed"><strong>3.1.1.2.</strong> Тариф &laquo;2в1&raquo; (включает в себя предоставление доступа к одной полной расшифровке &laquo;Матрицы Судьбы&raquo; и одному прогнозу на 10 ближайших. При этом доступ будет открыт сразу после оплаты).</p>
            <p className="text-gray-700 leading-relaxed"><strong>3.1.1.3.</strong> Тариф &laquo;Безлимит на год&raquo; (включает в себя предоставление доступа к неограниченному количеству расшифровок &laquo;Матрицы Судьбы&raquo; и прогнозам на 10 ближайших лет. При этом доступ будет открыт сразу после оплаты и предоставляется на 1 год).</p>
          </div>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-3 leading-relaxed">
            <strong>11.1.</strong> Сервис предоставляется на условиях &laquo;как есть&raquo;. Администрация не гарантирует, что Сервис будет соответствовать требованиям Пользователя, что доступ к Сервису будет предоставляться непрерывно, быстро, надежно и без ошибок.
          </p>
