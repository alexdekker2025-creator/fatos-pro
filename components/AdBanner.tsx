      ...
      <div className="relative h-64 sm:h-72">
        ...
        >
          {ads.map((ad) => (
            ...
            >
              <div className={`h-full bg-gradient-to-r ${ad.bgGradient} p-6 sm:p-8 flex flex-col justify-center items-center text-center`}>
                <div className="text-5xl sm:text-6xl mb-4">{ad.icon}</div>
