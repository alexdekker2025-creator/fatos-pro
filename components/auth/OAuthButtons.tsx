...
export default function OAuthButtons({ mode = 'login', disabled = false }: OAuthButtonsProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-center my-4">
        ...
        <div className="mx-3 text-purple-300 text-xs">{t('orContinueWith')}</div>
        <div className="h-px bg-purple-400/40 flex-1 max-w-[60px]"></div>
      </div>
      ...
      */}
      ...
      >
        ...
        {mode === 'login' ? t('continueWithFacebook') : t('linkFacebook')}
      </button>
    </div>
  );
}
